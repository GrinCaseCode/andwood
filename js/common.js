$(document).ready(function () {
	...
	$('.slider-billbord').slick({
		...
		slidesToShow: 1,
		slidesToScroll: 1,
		appendDots: $(".slider-controls_billbord"),
		appendArrows: $(".slider-controls_billbord"),
	...
	$('.slider-advantages').slick({
		...
		slidesToShow: 1,
		slidesToScroll: 1,
		appendDots: $(".slider-controls_advantages"),
	...
	$('.slider-etaps').each(function () {
		var $slider = $(this);
		$controls_slider = $('.slider-controls_etaps');
		...
		if ($slider.length) {
			...
			$slider.slick({
				...
				variableWidth: true,
				touchThreshold: 1000,
				appendArrows: $(".slider-controls_etaps"),
				prevArrow: '<div class="slick-prev slick-arrow"><i class="fal fa-chevron-left"></i><div/>',
				nextArrow: '<div class="slick-next slick-arrow"><i class="fal fa-chevron-right"></i><div/>',
				infinite: false,
				slidesToScroll: 1,
...
$(document).ready(function () {
	...
	function init() {
		var myMap = new ymaps.Map('map-contact1', {
			center: [44.970507, 34.153081],
			zoom: 16
		}, {
			searchControlProvider: 'yandex#search'
		});

		myPlacemark1 = new ymaps.Placemark([44.970507, 34.153081], {
		}, {
...
$(document).ready(function () {
	...
	function init() {
		var myMap = new ymaps.Map('map-contact2', {
			center: [44.982684, 34.150233],
			zoom: 16
		}, {
			searchControlProvider: 'yandex#search'
		});

		myPlacemark1 = new ymaps.Placemark([44.982684, 34.150233], {
		}, {
			iconLayout: 'default#image',
			iconImageHref: 'img/pin.svg',
			hideIconOnBalloonOpen: false,
...
$(document).ready(function () {
	...
	function init() {
		var myMap = new ymaps.Map('map-contact3', {
			center: [44.985622, 34.133181],
			zoom: 16
		}, {
			searchControlProvider: 'yandex#search'
		});

		myPlacemark1 = new ymaps.Placemark([44.985622, 34.133181], {
		}, {
			iconLayout: 'default#image',
			iconImageHref: 'img/pin.svg',
			hideIconOnBalloonOpen: false,
